...
OnInit.map(function()
    ...
    local fullscreenFrame = BlzCreateFrameByType("FRAME", "FullscreenParent", mainFrame, "", 0)
    ...
    local textureFrame = BlzCreateFrameByType("BACKDROP", "texture_frame", fullscreenFrame, "", 0)
    BlzFrameSetTexture(textureFrame, "ReplaceableTextures\\CommandButtons\\BTNPriest", 0, true)
    BlzFrameSetSize(textureFrame, 0.05, 0.05)
    BlzFrameSetPoint(textureFrame, FRAMEPOINT_TOPLEFT, fullscreenFrame, FRAMEPOINT_TOPLEFT, 0, 0)
    local textureFrame2 = BlzCreateFrameByType("BACKDROP", "texture_frame", fullscreenFrame, "", 0)
    ...
    BlzFrameSetPoint(textureFrame2, FRAMEPOINT_TOPRIGHT, fullscreenFrame, FRAMEPOINT_TOPRIGHT, 0, 0)
